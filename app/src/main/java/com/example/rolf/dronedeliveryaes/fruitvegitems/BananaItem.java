    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToCategory = new Intent(BananaItem.this, com.example.rolf.dronedeliveryaes.activities.Category.class);
        ...
        Track.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToTrack = new Intent(BananaItem.this, com.example.rolf.dronedeliveryaes.activities.Track.class);
        ...
        Cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToShoppingCart = new Intent(BananaItem.this, ShoppingCart.class);
