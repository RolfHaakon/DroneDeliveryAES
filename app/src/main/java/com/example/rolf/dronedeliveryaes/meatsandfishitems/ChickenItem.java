...
public class ChickenItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chicken_item);
        ...
        Home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent goToHomePage = new Intent(ChickenItem.this, HomePage.class);
        ...
        Account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToAccount = new Intent(ChickenItem.this, com.example.rolf.dronedeliveryaes.activities.Account.class);
        ...
        Category.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToCategory = new Intent(ChickenItem.this, com.example.rolf.dronedeliveryaes.activities.Category.class);
        ...
        Track.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToTrack = new Intent(ChickenItem.this, com.example.rolf.dronedeliveryaes.activities.Track.class);
        ...
        Cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToShoppingCart = new Intent(ChickenItem.this, ShoppingCart.class);
